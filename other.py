...
def invert_mat(mat):
    ...
    if determinant(mat) == 0:
        print("can't invert this matrix!\nDeterminant = 0")
        return inv_mat
...
def example():
    ...
    if determinant(example_mat) == 0:
        print("determinant of the matrix is 0, cant find transfer matrix.")
        return None
    print("===========================================")
...
#b = [[1],[2],[3],[4]]
#x = [[5,6,6,8],[2,2,2,8],[6,6,2,8],[2,3,6,7]]
example()